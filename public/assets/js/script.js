...
for (let i = 0; i < projectItems.length; i++) {
  ...
  link.addEventListener("click", function (e) {
    ...
    const title = projectItems[i].querySelector(".project-title").innerText;
    const category = projectItems[i].querySelector(".project-category").innerText;
    const details = projectItems[i].querySelector(".project-details").innerHTML;
